 ...
 * ```
 *
 * > This content is derived from https://github.com/terraform-providers/terraform-provider-vultr/blob/master/website/docs/r/startup_script.html.markdown.
 */
export class StartupScript extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: StartupScriptArgs | StartupScriptState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts && opts.id) {
            ...
            inputs["dateModified"] = state ? state.dateModified : undefined;
            ...
            inputs["dateModified"] = undefined /*out*/;
        }
        if (!opts) {
            opts = {}
        }
        ...
        super(StartupScript.__pulumiType, name, inputs, opts);
    }
}
...
export interface StartupScriptState {
     ...
     * Date the script was last modified.
     */
    readonly dateModified?: pulumi.Input<string>;
    /**
     * Name of the given script.
     */
