 ...
 *
 * > This content is derived from https://github.com/terraform-providers/terraform-provider-vultr/blob/master/website/docs/index.html.markdown.
 */
export class Provider extends pulumi.ProviderResource {
    ...
    constructor(name: string, args: ProviderArgs, opts?: pulumi.ResourceOptions) {
        let inputs: pulumi.Inputs = {};
        {
            ...
            inputs["rateLimit"] = pulumi.output(args ? args.rateLimit : undefined).apply(JSON.stringify);
            inputs["retryLimit"] = pulumi.output(args ? args.retryLimit : undefined).apply(JSON.stringify);
        }
        if (!opts) {
            opts = {}
        }
...
export interface ProviderArgs {
     ...
     */
    readonly retryLimit?: pulumi.Input<number>;
}
