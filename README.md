...
First, clone this repo with the name of the desired provider in place of `vultr`:

```
git clone https://github.com/pulumi/pulumi-tf-provider-boilerplate pulumi-vultr
```

Second, replace references to `vultr` with the name of your provider:
...
To use from Go, use `go get` to grab the latest version of the library
    ...
    $ go get github.com/pulumi/pulumi-vultr/sdk/go/...
...
- `vultr:region` (environment: `vultr_REGION`) - the region in which to deploy resources
